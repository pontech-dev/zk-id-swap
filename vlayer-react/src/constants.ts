import { sepolia, optimismSepolia, baseSepolia, flowTestnet, polygonZkEvmTestnet } from "viem/chains";

export const CHAINS = [sepolia, optimismSepolia, baseSepolia, flowTestnet, polygonZkEvmTestnet] as const;
