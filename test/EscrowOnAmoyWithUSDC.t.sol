...
contract MarketplaceEscrowTest is Test {
    ...
    address buyer = stringToAddress(vm.envString("AMOY_BUYER_ADDRESS"));

    function setUp() public {
        vm.createFork(vm.envString("AMOY_RPC_URL"));

        // USDC on Sepolia Network
        usdc = IUSDC(0x41E94Eb019C0762f9Bfcf9Fb1E58725BfB0e7582);
